...
img_yuv = cv2.cvtColor(f, cv2.COLOR_BGR2YCR_CB)
...
mask = cv2.inRange(img_yuv, (np.array([y-17,u-11,v-11])), (np.array([y+17,u+11,v+11])))
cv2.imwrite("Masking_ycrcb.jpg",mask)
