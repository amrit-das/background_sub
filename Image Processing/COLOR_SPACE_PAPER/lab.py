...
#f=cv2.imread('leaf.png')   
image1 = cv2.imread("img0.jpg")
image2 = cv2.imread("img2.jpg")
img_yuv = cv2.absdiff(image1,image2)
#img_yuv = cv2.cvtColor(f, cv2.COLOR_BGR2LAB)
...
cv2.imwrite("Masking_lab.jpg",mask)
...
cv2.imwrite("image_lab.jpg", img_yuv)
