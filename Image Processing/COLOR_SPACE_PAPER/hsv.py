...
img_yuv = cv2.cvtColor(f, cv2.COLOR_BGR2HSV)
...
#cv2.imwrite("hsv_board.jpg",img_yuv)
while True:
...
cv2.imwrite("Masking_hsv_board.jpg",mask)
...
cv2.imwrite("contour_hsv_board.jpg", img_yuv)
